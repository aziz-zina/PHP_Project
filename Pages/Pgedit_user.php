    ...
    <div id="frm2">
        <form name="f1" action="edit_user.php" method="POST">
            <center>
                ...
                <input type="text" id="login" readonly name="login" required placeholder="Login"  value="<?php echo $login ?>"/><br><br>
                
                <label> Email: </label><br>
                <input type="email" id="email" name="email" required placeholder="E-mail" value="<?php echo $mail ?>"/><br><br>

                <label> Name: </label><br>
                <input type="text" id="name" name="name" required placeholder="Name" value="<?php echo $name ?>"/><br><br>

                <label style="margin-left: -120px;"> Telephone: </label><br>
                <input type="tel" id="tel" name="tel" required placeholder="Telephone number" value="<?php echo $phone?>"/><br><br>
