        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                if (isset($_SESSION["login"])) {
                    ...
                    $sql = "SELECT * FROM reservation AS r INNER JOIN user as U1 ON r.idClient = U1.Login INNER JOIN user as U2 ON 	r.EmployeeUser = U2.Login where idClient='" . $_SESSION["login"] . "' ORDER BY time ";
